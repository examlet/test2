...
export default defineNuxtConfig({
  ...
  unocss: {
    ...
    shortcuts: [
      ['btn', 'px-4 py-1 rounded inline-block bg-teal-600 text-white cursor-pointer hover:bg-teal-700 disabled:cursor-not-allowed disabled:bg-gray-600 disabled:opacity-50'],
      ...
      ['link', 'font-sans text-base text-left text-teal-600 no-underline hover:underline decoration-teal-600 underline-offset-3'],
